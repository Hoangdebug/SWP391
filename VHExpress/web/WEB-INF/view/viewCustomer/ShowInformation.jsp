									...
									<table class="table form-info">
										<tbody>
											...
											<tr>
												...
												<td><input class="form-control input-sm" id="FullName"
													name="fullname" type="text" value="${user.getFullName()}" readonly="readlonly" >
													<span class="field-validation-valid"
													data-valmsg-for="FullName" data-valmsg-replace="true"></span>
												</td>
											</tr>
											<tr>
												...
												<td><input class="form-control input-sm" id="FullName"
													name="password" type="text" value="${user.getPassword()}" readonly="readlonly" >
													<span class="field-validation-valid"
													data-valmsg-for="FullName" data-valmsg-replace="true"></span>
												</td>
											</tr>
											<tr>
												...
												<td><input class="form-control input-sm"
													...
													value="${user.getRole()}" readonly="readlonly" > <span
										...
										<tbody>
											<tr>
												...
												<td><input class="form-control input-sm" id="Phone"
													name="phoneNum" type="text" value="${user.getPhoneNum()}" readonly="readlonly" ><span
											...
											<tr>
												...
												<td><input class="form-control input-sm" id="Address"
													name="address" type="text" value="${user.getAddress()}" readonly="readlonly" >
												</td>
											</tr>
											<tr>
												<td>Email <span style="color: red;">(*)</span></td>
												<td><input class="form-control input-sm" id="Email"
													name="email" type="text" value="${user.getEmail()}" readonly="readlonly" ></td>
											</tr>
											<tr>
											<tr>
												<!-- <td>ID User:</td> -->
												<td><input readonly="readlonly"
													...
													type="hidden" value="${user.getIdUser()}" readonly="readlonly" ></td>
											</tr>
										</tbody>
									</table>
								</div>
